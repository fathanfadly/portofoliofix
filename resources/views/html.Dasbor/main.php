  ...
  <body>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav flex-grow-1 justify-content-between">
              ...
              <li class="nav-item"><a class="nav-link"href="Example.html">Example</a></li>
    ...
    <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
      ...
      <br/>
        ...
        <div class="row">
            <div class="col-lg-4">
              <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="OIP.jpg" alt="Your Image" role="img" aria-label="Placeholder"><title>Placeholder</title>
              <br/>
              <br/>
              <p><a class="btn btn-secondary" href="#">View details »</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
              <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="Java.jpg" alt="Your Image" role="img" aria-label="Placeholder">
              <br/>
              <br/>
              <p><a class="btn btn-secondary" href="#">View details »</a></p>
            </div>
            <!-- /.col-lg-4 -->
            <div class="col-lg-4">
              <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="OIP.jpeg" alt="Your Image" role="img" aria-label="Placeholder">
            <br/>
            <br/>
              <p><a class="btn btn-secondary" href="#">View details »</a></p>
            </div>
          ...
          <div class="row featurette">
            ...
            <div class="col-md-5">
            <a href="https://www.w3schools.com/"><img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" src="w3schools.png" alt="Placeholder: 500x500"></a> 
            </div>
          </div>
          ...
          <div class="row featurette">
            ...
            <div class="col-md-5 order-md-1">
              <a href="https://getbootstrap.com/"><img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="400" height="400" src="bootstrap-logo.png" alt="Placeholder: 500x500"></a>
            </div>
          ...
          <div class="row featurette">
            ...
            <div class="col-md-5">
            <a href="https://www.w3schools.com/"><img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" src="laravel.jpeg" alt="Placeholder: 500x500"></a> 
            </div>
          </div>
